...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.openai_api_key = simpledialog.askstring("API Key", "Enter OpenAI API key:")
        ...
        # User Input Frame
        self.user_input_frame = tk.Frame(self.main_frame)
        self.user_input_frame.pack(side="bottom", fill="x")
        ...
        # Conversation Text Display Area
        self.conversation_text = scrolledtext.ScrolledText(self.main_frame, state='disabled')
